...
#define tokuM_new(C,t)          tokuM_mallot_(C, sizeof(t), 0)
#define tokuM_newarray(C,s,t)   tokuM_mallot_(C, (s)*sizeof(t), 0)
#define tokuM_newobj(C,tag,sz)  tokuM_mallot_(C, (sz), (tag))
...
#define tokuM_reallocarray(C,p,os,ns,t) \
        ((p) = tokuM_reallot_(C, p, (os)*sizeof(t), (ns)*sizeof(t)))
...
TOKUI_FUNC void *tokuM_mallot_(toku_State *T, t_umem size, int tag);
TOKUI_FUNC void *tokuM_reallot_(toku_State *T, void *ptr, t_umem osize,
                                t_umem nsize);
