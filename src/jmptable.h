...
static const void* toktable[TOK_EOF + 1] = {
    ...
    &&L_TOK_DOT,         &&L_TOK_DOT_DOT_DOT, &&L_TOK_COMMA,
    &&L_TOK_MINUS,       &&L_TOK_PLUS,        &&L_TOK_COLON,
    &&L_TOK_SEMICOLON,   &&L_TOK_SLASH,       &&L_TOK_STAR,
    &&L_TOK_PERCENT,     &&L_TOK_CARET,       &&L_TOK_QMARK,
    ...
    &&L_TOK_FALSE,       &&L_TOK_FOR,         &&L_TOK_FOREACH,
    &&L_TOK_FN,          &&L_TOK_IF,          &&L_TOK_IN,
    &&L_TOK_IMPL,        &&L_TOK_NIL,         &&L_TOK_OR,
    &&L_TOK_RETURN,      &&L_TOK_SUPER,       &&L_TOK_SELF,
    &&L_TOK_SWITCH,      &&L_TOK_TRUE,        &&L_TOK_VAR,
    &&L_TOK_WHILE,       &&L_TOK_LOOP,        &&L_TOK_FIXED,
